...
const Contact = props => {
  ...
  return (
    <div className="contact">
      ...
      <section>
        <p className="contact-message" style={styles.altColor}>My inbox is always open. Whether you have a project in mind or would just like to chat, please feel free to <a href="mailto:gabe.v.ng@gmail.com" style={styles.linkBorder} className="linked-text">reach out</a> and I'll get back to you!</p>
      <ul>
